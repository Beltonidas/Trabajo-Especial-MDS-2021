...
### quienes
>hacen uso del centro de acopio,

### el sistema de administración de reciclajes
>es una herramienta de organización y gestión 

#### que
>permite llevar un registro del material acopiado y conectar a los interesados en el reciclaje;

### a diferencia de
>un registro manual de lo recolectado por los cartoneros.
...
| :---: | :---: | :---: |
| Representante de cartoneros | los cartoneros |  Seguimiento del proyecto para que se cumplan las necesidades de los cartoneros |


| Nombre | Representa a | Responsabilidades  |
| :---: | :---: | :---: |
| Secretaria general | centro de acopio |  Seguimiento del proyecto y aprobación del presupuesto |


| Nombre | Representa a | Responsabilidades  |
| :---: | :---: | :---: |
| Delegado Vecinal| los ciudadanos |  Seguimiento para mantener informados a los ciudadanos |
...
| :---: | :---: | :---: | :---: | :---: |
| Registrar el peso de los materiales reciclados | Baja | El pesaje y registro de los materiales es ineficiente y rudimentario, carece de precisión | Los datos de pesaje se registran manualmente | Uso de balanzas bluetooth conectadas al sistema, al registrar el peso se envian los datos automáticamente |
| Coordinación de la ciudadanía mediante una cartelera de avisos | Media | Los ciudadanos no tienen forma de comunicarse con los vecinos “buena onda” para coordinar que pasen a retirar materiales reciclables por sus domicilios | Ir de manera individual al centro de acopio | Desarrollar cartelera virtual y una interfaz visual |
...
>Gestión de Materiales Reciclables: El sistema permite registrar el tipo de material junto con su pesaje y asigna los datos correspondientes al cartonero que los lleva.
...
>Este proyecto cambiará radical y eficientemente la forma de reciclar de la ciudad, con un sistema online de última generación que permitirá a los ciudadanos estar en contacto de forma fácil y rápida con el centro de acopio.
 
>A su vez, este software dará una herramienta crucial para la organización y distribución de los pedidos de retiro de materiales reciclables para la Cooperativa de Recuperadores Urbanos de Tandil, quienes tendrán una nueva forma equitativa de realizar su trabajo.

>El nuevo sistema dará acceso a los dirigentes del centro de acopio a una forma ágil de administrar y visualizar los datos del grupo de cartoneros, lo cual facilitará la distribución de las ventas. 
